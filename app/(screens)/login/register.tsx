          ...
          {({
            ...
            <>
              ...
              <Picker
                ...
                onValueChange={(itemValue) => setFieldValue('typeUser', itemValue)}
              >
                <Picker.Item label="Professor" value="1" />
                <Picker.Item label="Aluno" value="2" />
              </Picker>
              {touched.typeUser && errors.typeUser && <Text style={styles.error}>{errors.typeUser}</Text>}
              ...
              <View style={styles.buttonContainer}>
                {loading ? (
                  ...
                  <Button title="Registrar" color="#4e46dd" onPress={handleSubmit as any} />
                )}
              </View>
            </>
          )}
